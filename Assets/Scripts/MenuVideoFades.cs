...
public class MenuVideoFades : MonoBehaviour
{
    enum eFadeType{
		fade_in,
		fade_out
	...
	public GameObject canvasVideoSelect;
	...
	void Start(){
		...
		canvasVideoSelect.SetActive(false);
	}
	...
	public void AppearVideoMenu(){
		canvasMain.SetActive(false);
		canvasVideoSelect.SetActive(true);
	}
